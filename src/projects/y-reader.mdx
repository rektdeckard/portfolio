...
import yReaderVideo from "@assets/images/y-reader-video-crop-tc.mp4";
...
<AppWindow chrome title="YReader" caption="A modern Hacker News client">
  <ThemeFilter>
    <video autoPlay muted loop width="480">
      <source src={yReaderVideo} type="video/mp4" />
    </video>
  </ThemeFilter>
</AppWindow>
