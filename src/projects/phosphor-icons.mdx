...
import { PhosphorDemo } from "@components/PhosphorDemo";
...
<AppWindow chrome title="phosphoricons.com" caption="Above-the-fold content on the new Phosphor site">
  <ThemedImage
